...
unlocked to sign the Zestcoin-Qt.app bundle.
...
allowing somebody to distribute a Zestcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the zestcoin-qt.exe file inside the installer had not been tampered with.
